...
useful for ISP environments where some subscribers have passwords set,
and others do not (e.g. mixed IPoE and PPPoE).
...
anonymous bind when making any additional connections.  Setting this
to `yes` will either bind with the admin credentials or the
