...
If you want to add new features, you should target either the v3.2.x or v4.0.x branches. The instructions below show how to check out a branch if you need to work with it.
